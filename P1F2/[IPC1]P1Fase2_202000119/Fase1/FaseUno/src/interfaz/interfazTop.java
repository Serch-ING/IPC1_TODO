...
public class interfazTop extends JFrame{
	...
	public interfazTop(String aplicactionTitle,String charTitle,String app[][]){
	...
	public static void mayou(String app[][]) {
		...
		interfazTop inter = new interfazTop("Grafica ground 10", "Ground 10", app  );
