...
public class Reportes {
	...
	//Reportes Final
	public static String[] ReportShow = new String[10];
	...
	//menor
	 ...
	 //Ejecutar ReportesMEjer
	 public static void EjecucionReporteMenor() {
		 ...
		 ReporteMayores+= "<table class=\"steelBlueCols\">\r\n"
			...
			for(int p=0;p<6;p++) {
				...
				if(p == 0) {
					...
					ReporteMenores+= "<td> </td> " ;
					ReporteMenores+= "<td>" + menorM[p] +" </td> " ;
					ReporteMenores+= "<td>" + menorMNota[p] +" </td> " ;
			...
			ReporteMenores += "</tr></tbody></table><br>";
	 }
		 ...
		 ReporteMayores+= "<table class=\"steelBlueCols\">\r\n"
			...
			for(int p=0;p<6;p++) {
				...
				if(p == 0) {
					...
					ReporteMayores+= "<td> </td> " ;
					ReporteMayores+= "<td>" + mayorM[p] +" </td> " ;
					ReporteMayores+= "<td>" + mayorMNota[p] +" </td> " ;
	...
	public static void ReporteJuntar() {
				try{
				ReportShow[Menu.noUsuario] += ReporteMidAlum + ReporteMidPrf + ReporteMidCursos + ReporteMayores + ReporteMenores ;	
				//ReporteMostrar =  ReporteMidAlum + ReporteMidPrf + ReporteMidCursos + ReporteMayores + ReporteMenores ;
	...
	public static void ReporteMostrar() {
				...
				archivo.write(ReporteInicio+ "<center><h1 class=\"titulos\"><font size=\"30px\"><b>"+ Menu.useras[Menu.noUsuario][Menu.noUsuario]  +"</b></h1></center>"
						+ ReportShow[Menu.noUsuario]+ReporteFinal);
				archivo.close();
